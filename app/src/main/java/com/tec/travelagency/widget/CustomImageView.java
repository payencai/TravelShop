...
public class CustomImageView extends android.support.v7.widget.AppCompatImageView {
    ...
    public CustomImageView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        cornerRadius = ta.getInt(R.styleable.CustomImageView_cusCornerRadius, 50);
        //回收资源
        ta.recycle();
...
//        super.onDraw(canvas);
        ...
        switch (shape) {
            ...
            case ROUNDRECT:
                //绘制一个圆角矩形
                mCanvas.drawRoundRect(new RectF(0, 0, measuredWidth, measuredHeight), cornerRadius, cornerRadius, paint);
                break;
            case RECT:
