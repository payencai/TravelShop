...
//                    RVAdapter.Holder holder = (RVAdapter.Holder) getChildViewHolder(view);
                    ...
                    RVBaseViewHolder holder = (RVBaseViewHolder) getChildViewHolder(view);
                    //获得这个view的position
                    mPosition = holder.getAdapterPosition();
                    //获得这个view的整个布局
                    mItemLayout = (LinearLayout) holder.getView(R.id.llLayout);
                    //获得这个view的删除按钮
                    tvDelete = holder.getTextView(R.id.tvDelete);
                    //这个view的整个置顶按钮
                    tvTop = holder.getTextView(R.id.tvTop);
                    //两个按钮的宽度
