...
import com.tec.travelagency.common.bean.AddressBean;
import com.tec.travelagency.overlayutil.BikingRouteOverlay;
import com.tec.travelagency.overlayutil.DrivingRouteOverlay;
import com.tec.travelagency.overlayutil.MassTransitRouteOverlay;
import com.tec.travelagency.overlayutil.OverlayManager;
import com.tec.travelagency.overlayutil.TransitRouteOverlay;
import com.tec.travelagency.overlayutil.WalkingRouteOverlay;
...
//        PlanNode enNode = PlanNode.withCityNameAndPlaceName(mEndCity, endNodeStr);
        ...
        if (v.getId() == R.id.mass) {
            ...
            mSearch.transitSearch((new TransitRoutePlanOption()).from(stNode).city(mEndCity).to(enNode));
