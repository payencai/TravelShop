...
public class TicketOrderActivity extends BaseActivity {
    ...
    PlatTicketsSubDetailBean.TicketBean mCarRental;
    PlatTicketsSubDetailBean.TravelAgencyTicketBean mTravelAgencyCarRental;
    PlatTicketsSubDetailBean mPlatTicketsSubDetailBean;
    ...
    protected void initView() {
        ...
        mPlatTicketsSubDetailBean = (PlatTicketsSubDetailBean) getIntent().getSerializableExtra("ticket");
        mCarRental = mPlatTicketsSubDetailBean.getTicket();
        mTravelAgencyCarRental = mPlatTicketsSubDetailBean.getTravelAgencyTicket();
        time.setText(getDate());
        title.setText("支付订单");
        getDefaultData(mTravelAgencyCarRental.getTicketId(), getDate());
        initData();
    }

    private void getDefaultData(String id, String date) {
        Map<String, Object> parame = new HashMap<>();
        parame.put("ticketId", id);//人数
        parame.put("date", date);//人数
        Log.e("parame", parame.toString());
        HttpProxy.obtain().get(PlatformContans.Ticket.getDefaultDate, App.getInstance().getUserEntity().getToken(), parame, new ICallBack() {
            @Override
            public void OnLtSuccess(String result) {
                ...
                try {
                    ...
                    if (resultCode == 0) {
                        ...
                        room_surplus.setText("可定数量" + data);

                    } else {
                        ToaskUtil.showToast(TicketOrderActivity.this, message);
                    }
            ...
            switch (msg.what) {
                case SDK_PAY_FLAG: {
                    ...
                    if (TextUtils.equals(resultStatus, "9000")) {
                        ...
                        ToaskUtil.showToast(TicketOrderActivity.this,"下单成功");
                        finish();
    ...
    private void alipay(final String orderInfo){
        final Runnable payRunnable = new Runnable() {
            ...
            @Override
            public void run() {
                PayTask alipay = new PayTask(TicketOrderActivity.this);
    ...
    private void submitOrder(String phone, String name, final int payWay) {
        Map<String, Object> parame = new HashMap<>();
        parame.put("travelAgencyTicketId", mTravelAgencyCarRental.getId());//人数
        ...
        Log.e("parame", parame.toString());
        HttpProxy.obtain().post(PlatformContans.Ticket.addPlatTicketOrder, App.getInstance().getUserEntity().getToken(), parame, new ICallBack() {
            @Override
            public void OnLtSuccess(String result) {
                Log.e("add", result);
                try {
...
//                }
    ...
    private void initData() {
        ...
        gettime.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(TicketOrderActivity.this, OneCalenderActivity.class);
                intent.putExtra("ticket", mTravelAgencyCarRental.getTicketId());
        ...
        timeLayout.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(TicketOrderActivity.this, MoreInfoCalendarActivity.class);
                intent.putExtra("rent", mTravelAgencyCarRental.getTravelAgencyId());
                startActivityForResult(intent, 3);
            }
        });
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (TextUtils.isEmpty(contactName) || TextUtils.isEmpty(phone)) {
                    Toast.makeText(TicketOrderActivity.this, "输入不能为空！", Toast.LENGTH_LONG).show();
                    return;
                }
                //if(payType==1)
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == 3) {
            if (data != null) {
                ...
                ProductDatePrice productDatePrice = (ProductDatePrice) data.getSerializableExtra("num");
                ...
                room_surplus.setText("可定数量" + productDatePrice.getEmptyNum());
            }
        }
    }
