...
public class SearchResultActivity extends BaseActivity implements RVAdapter.ICallTel, RvItemActionListener {
...
//                    requestData(null, null, null, -1);
    ...
    @OnClick({R.id.back, R.id.locationSelect, R.id.starSelect, R.id.all})
            ...
            public void OnLtSuccess(String result) {
                ...
                try {
                    ...
                    if (resultCode == 0) {
                        ...
                        ToaskUtil.showToast(SearchResultActivity.this, message);
                    }
                } catch (Exception e) {
                    e.printStackTrace();
                }
    ...
    public void OnItemClick(int position) {
        ...
        HotelDetailActivity.startHotelDetail(SearchResultActivity.this, bean);
    }
