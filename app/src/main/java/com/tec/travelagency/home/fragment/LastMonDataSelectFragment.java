...
public class LastMonDataSelectFragment extends BaseFragment implements MonthMoneyDataFormView2.onIClickItem{
    @BindView(R.id.monthSignFormView)
    MonthMoneyDataFormView2 monthSignFormView;
    List<DayInfo> mDataSelectOtherBeans;

    public LastMonDataSelectFragment(List<DayInfo> dataSelectOtherBeans) {
        mDataSelectOtherBeans = dataSelectOtherBeans;
    }

    @Override
    protected int getContentId() {
        return R.layout.fragment_lastmon_data_select;
    }
