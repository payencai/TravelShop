...
public class CarOrderActivity extends BaseActivity {
    ...
    protected void initView() {
        ...
        mCarRental = (CarRental) getIntent().getSerializableExtra("mCarRental");
        mTravelAgencyCarRental = (TravelAgencyCarRental) getIntent().getSerializableExtra("mTravelAgencyCarRental");
        time.setText(getDate());
        title.setText("支付订单");
        getDefaultData(mTravelAgencyCarRental.getCarRentalId(), getDate());
        initData();
    }

    private void getDefaultData(String id, String date) {
        Map<String, Object> parame = new HashMap<>();
        parame.put("carRentalId", id);//人数
        parame.put("date", date);//人数
        Log.e("parame", parame.toString());
        HttpProxy.obtain().get(PlatformContans.CarRental.getDefaultDate, App.getInstance().getUserEntity().getToken(), parame, new ICallBack() {
            @Override
            public void OnLtSuccess(String result) {
                ...
                try {
                    ...
                    if (resultCode == 0) {
                        ...
                        ToaskUtil.showToast(CarOrderActivity.this, message);
                    }
            ...
            switch (msg.what) {
                case SDK_PAY_FLAG: {
                    ...
                    if (TextUtils.equals(resultStatus, "9000")) {
                        ...
                        ToaskUtil.showToast(CarOrderActivity.this,"下单成功");
                        finish();
    ...
    private void alipay(final String orderInfo){
        final Runnable payRunnable = new Runnable() {
            ...
            @Override
            public void run() {
                PayTask alipay = new PayTask(CarOrderActivity.this);
    ...
    private void submitOrder(String phone, String name, final int payWay) {
        Map<String, Object> parame = new HashMap<>();
        parame.put("travelAgencyCarRentalId", mTravelAgencyCarRental.getId());//人数
        ...
        Log.e("parame", parame.toString());
        HttpProxy.obtain().post(PlatformContans.CarRental.addCarOrder, App.getInstance().getUserEntity().getToken(), parame, new ICallBack() {
            @Override
            public void OnLtSuccess(String result) {
                Log.e("add", result);
                try {
...
//                }
    ...
    private void initData() {
        Glide.with(this).load(mCarRental.getImage1Url());
        ...
        gettime.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(CarOrderActivity.this, OneCalenderActivity.class);
                intent.putExtra("id", mTravelAgencyCarRental.getCarRentalId());
        ...
        timeLayout.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(CarOrderActivity.this, MoreInfoCalendarActivity.class);
                intent.putExtra("rent", mTravelAgencyCarRental.getCarRentalId());
                startActivityForResult(intent, 3);
            }
        });
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (TextUtils.isEmpty(contactName) || TextUtils.isEmpty(phone)) {
                    Toast.makeText(CarOrderActivity.this, "输入不能为空！", Toast.LENGTH_LONG).show();
                    return;
                }
                //if(payType==1)
