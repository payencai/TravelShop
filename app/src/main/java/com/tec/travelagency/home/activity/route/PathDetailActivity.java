...
//    TextView instr;
    ...
    private void setUi(SalePathBean saleCarBean) {
        ...
        banner.setImageLoader(new com.youth.banner.loader.ImageLoader() {
            ...
            public void displayImage(Context context, Object path, ImageView imageView) {
                ...
                Glide.with(PathDetailActivity.this).load((String) path).into(imageView);
            }
        });
        ...
        addressDetail.setText(saleCarBean.getPlaceBegin() + saleCarBean.getPlaceBeginDetail());
        oneselfBuy.setVisibility(View.GONE);
    ...
    private void setUi(Route carRental, TravelAgencyRoute travelAgencyCarRental) {
        ...
        banner.setImages(list);//设置图片源
        banner.start();
        type.setText("出发点:" + mCarRental.getPlaceBegin());
        Log.e("ui", "ui");
        cartype.setText("路线时长:" + carRental.getRouteUsedTime());
        ...
        scale.setText("好评率: " + s);
        des.setText(carRental.getPeriodOfValidity());
        troduce.setText(carRental.getRegulation());
        tishi.setText(carRental.getWarmPrompt());
        addressDetail.setText(carRental.getPlaceBegin() + carRental.getPlaceBeginDetail());
    ...
    protected void initView() {
        ...
        comment.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                CommentActivity.startCommentActivity(PathDetailActivity.this,3,id);
            }
        });
        ...
        oneselfBuy.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(PathDetailActivity.this, PathOrderActivity.class);
    ...
    private void getSaleDetail(String id) {
        ...
        HttpProxy.obtain().get(PlatformContans.Path.getSalePathDetail, token, parame, new ICallBack() {
            @Override
            public void OnLtSuccess(String result) {
                ...
                try {
                    ...
                    if (resultCode == 0) {
                        ...
                        saleCarBean = gson.fromJson(data.toString(), SalePathBean.class);
                        setUi(saleCarBean);
                    } else {
                        ToaskUtil.showToast(PathDetailActivity.this, message);
                    }
                } catch (Exception e) {
                    e.printStackTrace();
                }
    ...
    public void showMyDialog(final int type) {
        ...
        helpprice.setVisibility(View.GONE);
    ...
    private void getDetail(String id) {
        ...
        parame.put("id", id);
        String token = App.getInstance().getUserEntity().getToken();
        HttpProxy.obtain().get(PlatformContans.Path.getPlatPathDetail, token, parame, new ICallBack() {
            @Override
            public void OnLtSuccess(String result) {
                ...
                try {
                    ...
                    if (resultCode == 0) {
                        JSONObject data = object.getJSONObject("data");
                        JSONObject carRental = data.getJSONObject("route");
                        JSONObject travelAgencyCarRental = data.getJSONObject("travelAgencyRoute");
                        mCarRental = gson.fromJson(carRental.toString(), Route.class);
                        mTravelAgencyCarRental = gson.fromJson(travelAgencyCarRental.toString(), TravelAgencyRoute.class);
    ...
    private void updatePrice(double price) {
        ...
        HttpProxy.obtain().post(PlatformContans.Path.updatePlatPathPrice, App.getInstance().getUserEntity().getToken(), parame, new ICallBack() {
            @Override
            public void OnLtSuccess(String result) {
                ...
                try {
                    ...
                    String message = object.getString("message");
                    if (resultCode == 0) {
                        ToaskUtil.showToast(PathDetailActivity.this, "修改成功");
                        getDetail(id);
                    } else {
                        ToaskUtil.showToast(PathDetailActivity.this, message);
                    }
    ...
    private void adopt() {
        ...
        if (mTravelAgencyCarRental != null) {
            ...
            url = PlatformContans.Path.adapotPlatPath;
            parame.put("id", mTravelAgencyCarRental.getId());
        } else {
            url = PlatformContans.Path.adapotSalePath;
        ...
        HttpProxy.obtain().post(url, App.getInstance().getUserEntity().getToken(), parame, new ICallBack() {
            ...
            public void OnLtSuccess(String result) {
                ...
                try {
                    ...
                    String message = object.getString("message");
                    if (resultCode == 0) {
                        ToaskUtil.showToast(PathDetailActivity.this, "上架成功");
                        if (flag != null) {
                            up.setText("下架");
                            getSaleDetail(id);
                        } else {
    ...
    private void cancel() {
        ...
        String url = "";
        if (mTravelAgencyCarRental != null) {
            url = PlatformContans.Path.removePlatPath;
            parame.put("id", mTravelAgencyCarRental.getId());
        } else {
            url = PlatformContans.Path.removeSalePath;
            parame.put("id", saleCarBean.getId());
        }
        HttpProxy.obtain().post(url, App.getInstance().getUserEntity().getToken(), parame, new ICallBack() {
            @Override
            public void OnLtSuccess(String result) {
                ...
                try {
                    ...
                    String message = object.getString("message");
                    if (resultCode == 0) {
                        ToaskUtil.showToast(PathDetailActivity.this, "下架成功");
                        if (flag != null) {
                            getSaleDetail(id);
                            up.setText("上架");
                        } else {
