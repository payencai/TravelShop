...
public class PathOneMonthActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_path_one_month);
        ...
        findViewById(R.id.confirm).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (dataSet.size() == 0) {
                    ToastUtils.showLongToast(PathOneMonthActivity.this, "请至少选择一个日期");
                    return;
                }
            ...
            public void OnLtSuccess(String result) {
                try {
                    ...
                    if (resultCode == 0) {
                        ...
                        ToaskUtil.showToast(PathOneMonthActivity.this, message);
                    }
    ...
    private void setData(final List<ProductDatePrice> mDatePriceList) {
        ...
        String maxDate = "";
        if (curMonth == 12) {
            maxDate = (curYear + 1) + "-" + 01 + "-" + today;
        } else {
            maxDate = curYear + "-" + (curMonth + 1) + "-" + today;
        }
        ...
        this.calendarView.init(new CommonCalendarView.DatePickerController() {
            ...
            public void onDayOfMonthSelected(int year, int month, int day) {
                Toast.makeText(PathOneMonthActivity.this, String.format("%s-%s-%s", year, StringUtils.leftPad(String.valueOf(month), 2, "0"),
            ...
            public void onDayOfMonthAndDataSelected(int year, int month, int day, List obj, View view, SparseArray<GridView> gridViewSparseArray, int curpage) {
                ...
                for (int i = 0; i < obj.size(); i++) {
                    ...
                    if (TextUtils.equals(datePrice.getDate(), priceDate)) {
                        ...
                        if (curpage == 0) {
                            GridView anotherGridView = gridViewSparseArray.get(1);
                            if (dataSet.size() == 0) {
                                ...
                                if (dataSet.size() == 1) {
                                    if (!dataSet.contains(datePrice.getDate())) {
                                        ...
                                        dataSet.remove(date);
                                        anotherGridView.getChildAt(pos).setBackgroundColor(Color.WHITE);
                            ...
                            GridView anotherGridView = gridViewSparseArray.get(0);
                            if (dataSet.size() == 0) {
                                dataSet.add(datePrice.getDate());
                                view.setBackgroundColor(getResources().getColor(R.color.fbutton_color_sun_flower));
                                datePositions.put(datePrice.getDate(), position);
