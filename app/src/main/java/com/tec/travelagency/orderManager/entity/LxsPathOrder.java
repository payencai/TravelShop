 ...
 * 邮箱：771548229@qq..com
 */
public class LxsPathOrder extends RVBaseCell implements Serializable {
    ...
    public void onBindViewHolder(RVBaseViewHolder holder, int position, final Context context, RVBaseAdapter adapter) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent=new Intent(context, PathOrderDelActivity.class);
