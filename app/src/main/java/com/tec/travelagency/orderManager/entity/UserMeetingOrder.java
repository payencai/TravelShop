...
import com.tec.travelagency.orderManager.fragment.user.UserMeetOrderDelActivity;
 ...
 * 邮箱：771548229@qq..com
 */
public class UserMeetingOrder extends RVBaseCell implements Serializable {
    ...
    public UserMeetingOrder(Object o) {
        super(null);
    }
...
//        view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_account_paid_order_rv_layout2, parent, false);
    ...
    public void onBindViewHolder(RVBaseViewHolder holder, int position, final Context context, RVBaseAdapter adapter) {
        ...
        holder.setText(R.id.visi_time,firstDate.substring(0,10)+"---"+lastDate.substring(0,10) +"   "+"1天");
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent=new Intent(context, UserMeetOrderDelActivity.class);
