...
import com.tec.travelagency.orderManager.fragment.user.UserTicketsOrderDelActivity;
 ...
 * 邮箱：771548229@qq..com
 */
public class UserTicketsOrder extends RVBaseCell implements Serializable {
    ...
    public UserTicketsOrder(Object o) {
        super(o);
    }
    ...
    public void onBindViewHolder(RVBaseViewHolder holder, int position, final Context context, RVBaseAdapter adapter) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent=new Intent(context, UserTicketsOrderDelActivity.class);
