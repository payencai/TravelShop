...
import com.tec.travelagency.orderManager.fragment.user.UserHotelOrderDelActivity;
 ...
 * 邮箱：771548229@qq..com
 */
public class UserHotelOrder extends RVBaseCell implements Serializable {
    ...
    public UserHotelOrder(Object o) {
        super(o);
    }
    ...
    public void onBindViewHolder(RVBaseViewHolder holder, int position, final Context context, RVBaseAdapter adapter) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent=new Intent(context, UserHotelOrderDelActivity.class);
